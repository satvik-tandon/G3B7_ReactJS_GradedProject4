    ...
    case "LOADED":
      ...
      el = (
        <div>
          ...
          <Row className="mx-3 my-5 m text-white">
            <Col xs={12} lg={3} className="my-3 text-white">
              <img
            ...
            <Col xs={12} lg={8} className="my-3 text-white">
              <div>
                <h2>
                  {title} ({year})
                </h2>
              ...
              <div className="my-4 text-white">
                ...
                <Row className="my-2 text-white">
                  ...
                  <Col xs={8}>
                    {genres.map((genres) => (
                      <span className="me-2 text-white" key={genres}>
                        {genres}
                      </span>
                    ))}
                  </Col>
                ...
                <Row className="my-2 text-white">
                  ...
                  <Col xs={8}>
                    {actors.map((actors) => (
                      <span className="me-2 text-white" key={actors}>
                        {actors}
                      </span>
                    ))}
                  </Col>
